...
# Hermit Finance — SUI ↔ hSui swap (deposit / mint / burn / withdraw).

# Salmon Launchpad — No-code game builder with templates (incl. 5×5 customizable Yut-like board): drag & drop, tile properties, rule editor, testplay.

# Splash Zone — Game gallery, matchmaking, PvP with SUI staking and on-chain settlement (Match contract).
